            ...
            return (
              <View key={index} style={styles.toc}>
                ...
                {block.items.map((item) => (
                  <View key={item.href} style={styles.tocItem}>
...
function makeStyles(colors: ReturnType<typeof useTheme>['colors']) {
  return StyleSheet.create({
    ...
    tocItem: { minHeight: 40, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderTopWidth: 1, borderTopColor: colors.line, paddingVertical: spacing.sm },
    tocBullet: { color: colors.terreStrong, fontFamily: fonts.bodyBold, fontSize: 17 },
