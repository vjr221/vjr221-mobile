...
function RegionScreen({ id, onOpenDepartment, onOpenContent }: { id: number; onOpenDepartment: (id: number) => void; onOpenContent: (item: ContentItem) => void }) {
  ...
  return (
    <View>
      <GeoDetailCard title={region.title} slug={region.slug} excerpt={region.excerpt} content={content} image={region.image} infos={region.infos} breadcrumb={t('region')} cta={cta} gps={region.gps} usefulLinks={usefulLinks} permalink={region.permalink} />
...
function DepartmentScreen({ id, onOpenCommune, onOpenContent }: { id: number; onOpenCommune: (id: number) => void; onOpenContent: (item: ContentItem) => void }) {
  ...
  return (
    <View>
      <GeoDetailCard title={department.title} slug={department.slug} excerpt={department.excerpt} content={content} image={department.image} infos={department.infos} breadcrumb={refLabel(department.region?.name) ?? t('department')} cta={cta} gps={department.gps} usefulLinks={usefulLinks} permalink={department.permalink} />
...
function CommuneScreen({ id, onOpenVillage, onOpenContent }: { id: number; onOpenVillage: (id: number) => void; onOpenContent: (item: ContentItem) => void }) {
  ...
  return (
    <View>
      <GeoDetailCard title={commune.title} slug={commune.slug} excerpt={commune.excerpt} content={content} image={commune.image} infos={commune.infos} breadcrumb={refLabel(commune.departement?.name) ?? t('commune')} cta={cta} gps={commune.gps} usefulLinks={usefulLinks} permalink={commune.permalink} />
...
function VillageScreen({ id }: { id: number }) {
  ...
  return <GeoDetailCard title={village.title} slug={village.slug} excerpt={village.excerpt} content={content} image={village.image} infos={village.infos} breadcrumb={refLabel(village.commune?.name) ?? t('village')} cta={cta} gps={village.gps} usefulLinks={usefulLinks} permalink={village.permalink} />;
}
