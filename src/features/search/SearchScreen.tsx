...
const styles = StyleSheet.create({
  ...
  title: { color: colors.ink, fontSize: 30, fontWeight: '800', marginTop: spacing.md, marginBottom: spacing.md },
  offline: { backgroundColor: colors.sand, borderRadius: radii.sm, padding: spacing.sm, marginBottom: spacing.md },
  offlineText: { color: colors.primaryDark, fontWeight: '600', fontSize: 12 },
  input: { backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, borderRadius: 14, height: 50, paddingHorizontal: spacing.md, color: colors.ink, fontSize: 16, marginBottom: spacing.lg },
});
